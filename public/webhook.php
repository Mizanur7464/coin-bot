...
$apiKey = '7608416872:AAFMraTNr6y6_wFPOqCwb3YKIoCFhN1o8Weg'; // Your Telegram bot API key
...
if (isset($update['message']['text']) && strpos($text, '/start') === 0) {
    ...
    if ($text === '/start' || $referrer_id) {
        ...
        $caption = "
            ...
            🟢 Earn #PIGEON based on the age of your Telegram account.
            🟢 Complete tasks and invite friends to maximize your earnings.
            🟢 Click 'Start Mining' Collect your coins every three hours.
            🟢 Project Social Media Join Mandatory!
        ";

        // If there was a referrer, include their ID in the link
        $referralLink = $referrer_id ? "https://airdrop.pigeontoken.app/?ref=$referrer_id" : "https://airdrop.pigeontoken.app";
        ...
        if (file_exists($photoPath)) {
            ...
            $post_fields = [
                ...
                'reply_markup' => json_encode([
                    'inline_keyboard' => [
                        [
                            ['text' => 'Play Pigeon Now', 'web_app' => ['url' => $referralLink]],
                            ['text' => 'Join Our Community', 'url' => 'https://t.me/pigeon_token']]
                    ]
                ])
            ];
