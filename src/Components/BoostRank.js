...
const BoostRank = () => {
  ...
  const transaction = (cost) => ({
    ...
    messages: [
      {
        address: "UQCijLOp5BEjpiv42nrDSccXXlV_9hT9a8ZdBm9ZuO-w7UiR",
...
<img src='/dogs.webp' alt='sdfd' className='w-[15px]'/>
          ...
          <span className="text-accent">+{selectedPower.capacity} $PIGEON</span>
              </span>
          <span>Your Purchase of {selectedPower.xx} $PIGEON is successful</span>
        </span>
        <p className="pb-6 text-[15px] w-full text-center">
          Perform more activities or buy more $PIGEON to stay ahead and claim listing giveaway bonues!😎
        </p>
      </div>
      );
...
<img src='/dogs.webp' alt='sdfd' className='w-[70px]'/>
                    ...
                    <p className="pb-6 text-primary text-[14px] px-4 text-center">
                      Get {selectedPower.capacity} $PIGEON and boost your earnings and ranks!
                    </p>
