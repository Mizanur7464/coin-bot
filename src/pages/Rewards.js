...
const friendsRewards = [
  { title: 'Invite 3 friends', referralsRequired: 2, bonusAward: 5000 },
  { title: 'Invite 5 friends', referralsRequired: 5, bonusAward: 15000 },
  { title: 'Invite 10 friends', referralsRequired: 10, bonusAward: 25000 },
  ...
  { title: 'Invite 100 friends', referralsRequired: 100, bonusAward: 200000 },
];
        ...
        setModalMessage(
          <div className="w-full flex justify-center flex-col items-center space-y-3">
            ...
            <h3 className="font-medium text-[20px] text-[#ffffff] pt-2 pb-2">
              <span className="text-accent">+{formatNumber(reward.bonusAward)}</span> $PIGEON CLAIMED
            </h3>
