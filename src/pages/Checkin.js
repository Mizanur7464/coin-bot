...
const DailyCheckIn = () => {
  ...
  const bonusPoints = [500, 1000, 2500, 5000, 15000, 25000, 100000, 200000, 300000, 400000, 500000, 1000000, 2000000, 3000000, 5000000];
...
<div className={`w-full flex-col pb-4 flex items-center justify-center text-center pt-4`}>
    ...
    <FaCalendarAlt size={40} className='text-accent'/>
            ...
            <p className='text-[14px] leading-[24px]'>
             Accrue $PIGEON tokens for logging into the game daily and maintain consistency for reward streaks!
            </p>
          </div>
