...
const Ref = () => {
  ...
  const copyToClipboard = () => {
    ...
    const reflink = `https://t.me/Pigeon_Token_bot?start=r${id}\n\☑️ Earn $PIGEON based on the age of your Telegram account. ☑️ Complete tasks and invite friends to maximize your earnings. ☑️ Click 'Start Mining' Collect your coins every three hours! 🚀`;
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Mine $Pigeon tokens now!",
      // eslint-disable-next-line
      url: `https://t.me/Pigeon_Token_bot?start=r${id}\n\ `, // Replace with your link
      text: "☑️ Earn $PIGEON based on the age of your Telegram account. ☑️ Complete tasks and invite friends to maximize your earnings. ☑️ Click 'Start Mining' Collect your coins every three hours! 🚀",
    };
          ...
          <div className="w-full pt-3 justify-center flex-col space-y-3 px-5">
            <div className="w-full flex justify-center">
              <h1 className="font-semibold text-[28px] text-[#ffffffe0] pb-1 text-center">
                Invite friends <br/>& get more $Pigeon
              </h1>
            </div>
